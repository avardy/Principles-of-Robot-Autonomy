...
\pause
\begin{center}
    \includegraphics[width=0.85\linewidth]{../book/figs/ch12_figs/lecun.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.75\linewidth]{../book/figs/ch12_figs/convolution.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.6\linewidth]{../book/figs/ch12_figs/convolution2.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.7\linewidth]{../book/figs/ch12_figs/features.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.55\linewidth]{../book/figs/ch12_figs/maxpool.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.6\linewidth]{../book/figs/ch12_figs/boundingbox.png}
\end{center}
\end{frame}
% --- Original text start ---
