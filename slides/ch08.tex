...
\pause
\begin{center}
    \includegraphics[width=0.55\linewidth]{../tex/figs/ch08_figs/imageframe.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.62\linewidth]{../tex/figs/ch08_figs/world2camera.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.75\linewidth]{../tex/figs/ch08_figs/pinholecamera2.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.7\linewidth]{../tex/figs/ch08_figs/lensdistortion.png}
\end{center}
\end{frame}
% --- Original text start ---
