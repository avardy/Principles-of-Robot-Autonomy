...
\pause
\begin{center}
    \includegraphics[width=0.8\linewidth]{../book/figs/ch13_figs/map.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.6\linewidth]{../book/figs/ch13_figs/distributions.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.55\linewidth]{../book/figs/ch13_figs/hmm.png}
\end{center}
\end{frame}
% --- Original text start ---
