...
\pause
\begin{center}
    \includegraphics[width=0.6\linewidth]{../tex/figs/ch01_figs/wheel_roll.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.4\linewidth]{../tex/figs/ch01_figs/pendulum.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.4\linewidth]{../tex/figs/ch01_figs/unicycle.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.45\linewidth]{../tex/figs/ch01_figs/diff_drive.png}
\end{center}
\end{frame}
% --- Original text start ---
