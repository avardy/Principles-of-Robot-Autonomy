...
\pause
\begin{center}
    \includegraphics[width=0.55\linewidth]{../book/figs/ch19_figs/fsm.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.72\linewidth]{../book/figs/ch19_figs/px4_state_machine.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.9\linewidth]{../book/figs/ch19_figs/parkinggate_fsm.png}
\end{center}
\end{frame}
% --- Original text start ---
