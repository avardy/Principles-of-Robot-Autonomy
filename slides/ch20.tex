...
\pause
\begin{center}
    \includegraphics[width=0.6\linewidth]{../tex/figs/ch20_figs/princopt1.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.68\linewidth]{../tex/figs/ch20_figs/princopt2.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.8\linewidth]{../tex/figs/ch20_figs/dpexample.png}
\end{center}
\end{frame}
% --- Original text start ---
