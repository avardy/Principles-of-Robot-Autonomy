...
\end{itemize}
\begin{center}
    \includegraphics[width=0.75\linewidth]{../tex/figs/app01_figs/activations.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\end{itemize}
\begin{center}
    \includegraphics[width=0.58\linewidth]{../tex/figs/app01_figs/backprop.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\end{itemize}
\begin{center}
    \includegraphics[width=0.6\linewidth]{../tex/figs/app01_figs/graph.png}
\end{center}
\end{frame}
% --- Original text start ---
