...
\pause
\begin{center}
\includegraphics[width=0.5\linewidth]{../tex/figs/ch03_figs/unicycle_cartesian.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
\includegraphics[width=0.5\linewidth]{../tex/figs/ch03_figs/unicycle_polar.png}
\end{center}
\end{frame}
% --- Original text start ---
