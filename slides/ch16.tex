...
\pause
\begin{center}
    \includegraphics[width=0.75\linewidth]{../tex/figs/ch16_figs/location_based_maps.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.75\linewidth]{../tex/figs/ch16_figs/feature_based_maps.png}
\end{center}
\end{frame}
% --- Original text start ---
