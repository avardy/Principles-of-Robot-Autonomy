...
\pause
\begin{center}
    \includegraphics[width=0.65\linewidth]{../tex/figs/ch07_figs/wheel_encoder.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.6\linewidth]{../tex/figs/ch07_figs/gyro.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.65\linewidth]{../tex/figs/ch07_figs/imu.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.58\linewidth]{../tex/figs/ch07_figs/Velodyne_64e.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.78\linewidth]{../tex/figs/ch07_figs/pinhole.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.7\linewidth]{../tex/figs/ch07_figs/pinholecamera.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.68\linewidth]{../tex/figs/ch07_figs/thinlens.png}
\end{center}
\end{frame}
% --- Original text start ---
