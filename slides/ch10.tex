...
\pause
\begin{center}
    \includegraphics[width=0.7\linewidth]{../book/figs/ch10_figs/spatialfiltering.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.58\linewidth]{../book/figs/ch10_figs/topleftfilter_padding.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.72\linewidth]{../book/figs/ch10_figs/gaussianfilter.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.7\linewidth]{../book/figs/ch10_figs/track_sobel.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.55\linewidth]{../book/figs/ch10_figs/edge_detection.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.62\linewidth]{../book/figs/ch10_figs/edge_detection_smooth.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.8\linewidth]{../book/figs/ch10_figs/sobel.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.78\linewidth]{../book/figs/ch10_figs/canny.png}
\end{center}
\end{frame}
% --- Original text start ---
