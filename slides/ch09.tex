...
\pause
\begin{center}
    \includegraphics[width=0.7\linewidth]{../book/figs/ch09_figs/stereo.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.65\linewidth]{../book/figs/ch09_figs/rectification.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.74\linewidth]{../book/figs/ch09_figs/triangulation.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.8\linewidth]{../book/figs/ch09_figs/disparitymap.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.65\linewidth]{../book/figs/ch09_figs/sfm.png}
\end{center}
\end{frame}
% --- Original text start ---
