...
\pause
\begin{center}
    \includegraphics[width=0.75\linewidth]{../book/figs/ch11_figs/iterative_end_point_fit.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.75\linewidth]{../book/figs/ch11_figs/ransac.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.7\linewidth]{../book/figs/ch11_figs/hough.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.7\linewidth]{../book/figs/ch11_figs/hough4.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.5\linewidth]{../book/figs/ch11_figs/polarlinefit.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.55\linewidth]{../book/figs/ch11_figs/image_pyramid.png}
\end{center}
\end{frame}
% --- Original text start ---
