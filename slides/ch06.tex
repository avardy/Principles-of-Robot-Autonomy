...
\begin{center}
    \includegraphics[width=0.7\linewidth]{../book/figs/ch06_figs/prm.png}
\end{center}
\pause
\begin{itemize}
...
\begin{center}
    \includegraphics[width=0.7\linewidth]{../book/figs/ch06_figs/rrt.png}
\end{center}
\pause
\begin{itemize}
...
\pause
\begin{center}
    \includegraphics[width=0.7\linewidth]{../book/figs/ch06_figs/fmt.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.45\linewidth]{../book/figs/ch06_figs/driftless.png}\hspace{1em}
    \includegraphics[width=0.45\linewidth]{../book/figs/ch06_figs/drift.png}
\end{center}
\end{frame}
% --- Original text start ---
