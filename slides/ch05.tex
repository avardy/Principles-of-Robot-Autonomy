...
\pause
\begin{center}
    \includegraphics[width=0.8\linewidth]{../book/figs/ch05_figs/2d_ws_obstacles.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.8\linewidth]{../book/figs/ch05_figs/S1_obstacle.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.65\linewidth]{../book/figs/ch05_figs/2d_ws_grid.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.42\linewidth]{../book/figs/ch05_figs/depth_first.PNG}\hspace{1em}
    \includegraphics[width=0.42\linewidth]{../book/figs/ch05_figs/breadth_first.PNG}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.58\linewidth]{../book/figs/ch05_figs/obs_padding.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.62\linewidth]{../book/figs/ch05_figs/2d_ws_Cfree.png}
\end{center}
\end{frame}
% --- Original text start ---
...
\pause
\begin{center}
    \includegraphics[width=0.7\linewidth]{../book/figs/ch05_figs/2d_cell_decomp.png}
\end{center}
\end{frame}
% --- Original text start ---
